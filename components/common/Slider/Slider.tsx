  ...
  return (
    <>
      ...
      >
        {/* <!--Carousel indicators--> */}
        <div
          className="absolute bottom-6 left-0 right-0 mx-[15%] mb-4 flex list-none justify-center p-0"
        >
          <button
            type="button"
            aria-label="Slide 1"
        ...
        <div className="relative whitespace-nowrap w-full md:w-5/6 md:mx-auto overflow-hidden after:clear-both after:block after:content-['']">
          ...
          >
            <Image
              ...
              className="block w-full !relative image-spinner"
              loading="lazy"
              placeholder="empty"
              fill
              alt="slides"
        ...
        <button
          className="absolute bottom-12 left-0 top-0 flex w-[10%] items-center justify-center border-0 bg-none p-0 text-center text-white  md:text-slate-400 opacity-60 transition-opacity duration-150 ease-[cubic-bezier(0.25,0.1,0.25,1.0)] hover:text-white md:hover:text-slate-500 hover:no-underline hover:opacity-90 hover:outline-none focus:no-underline  focus:outline-none motion-reduce:transition-none"
          type="button"
          name="prev"
          onClick={handleClick}
        >
        ...
        <button
          className="absolute bottom-12 right-0 top-0 flex w-[10%] items-center justify-center border-0 bg-none p-0 text-center text-white md:text-slate-400 opacity-60 transition-opacity duration-150 ease-[cubic-bezier(0.25,0.1,0.25,1.0)] hover:text-white md:hover:text-slate-500 hover:no-underline hover:opacity-100 hover:outline-none focus:no-underline focus:outline-none motion-reduce:transition-none"
          type="button"
          name="next"
          onClick={handleClick}
        >
